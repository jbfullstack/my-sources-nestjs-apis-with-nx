...
const ngcc_transform_compiler_host_1 = require("ng-packagr/lib/ts/ngcc-transform-compiler-host");
...
function compileSourceFiles(graph, tsConfig, moduleResolutionCache, extraOptions, stylesheetProcessor, ngccProcessor, watch) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        let tsCompilerHost = (0, cache_compiler_host_2.cacheCompilerHost)(graph, entryPoint, tsConfigOptions, moduleResolutionCache, stylesheetProcessor, inlineStyleLanguage);
        if (ngccProcessor) {
            tsCompilerHost = (0, ngcc_transform_compiler_host_1.ngccTransformCompilerHost)(tsCompilerHost, tsConfigOptions, ngccProcessor, moduleResolutionCache);
        }
