...
function insertNgModuleProperty(tree, modulePath, name, property) {
    ...
    try {
        ...
        ngModuleDecorator = (0, typescript_1.getDecorators)(ngModuleClassDeclaration).find((decorator) => (0, typescript_1.isCallExpression)(decorator.expression) &&
        ...
        // @ts-ignore
        ngModuleDecorator = ngModuleClassDeclaration.decorators.find((decorator) => (0, typescript_1.isCallExpression)(decorator.expression) &&
            (0, typescript_1.isIdentifier)(decorator.expression.expression) &&
            decorator.expression.expression.escapedText === ngModuleName);
    }
...
function findDecoratedClass(sourceFile, ngModuleName) {
    ...
    return classDeclarations.find((declaration) => {
        ...
        if (decorators) {
            return decorators.some((decorator) => (0, typescript_1.isCallExpression)(decorator.expression) &&
                (0, typescript_1.isIdentifier)(decorator.expression.expression) &&
                decorator.expression.expression.escapedText === ngModuleName);
        }
        return undefined;
