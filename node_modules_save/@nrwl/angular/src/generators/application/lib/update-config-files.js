...
function updateTsConfigOptions(host, options) {
    ...
    // tsconfig.json
    (0, devkit_1.updateJson)(host, `${options.appProjectRoot}/tsconfig.json`, (json) => (Object.assign(Object.assign({}, json), { compilerOptions: Object.assign(Object.assign({}, json.compilerOptions), { target: 'es2020' }) })));
}
