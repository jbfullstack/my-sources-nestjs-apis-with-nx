(function (global, factory) {
    ...
    (global = global || self, factory(global.ngApolloLinkHttpCommon = {}, global.rxjs));
    ...
    ***************************************************************************** */
    ...
    var fetch = function (req, httpClient, extractFiles) {
        ...
        // create a request
        return httpClient.request(req.method, req.url, __assign(__assign({ observe: 'response', responseType: 'json', reportProgress: false }, bodyOrParams), req.options));
    };
...
//# sourceMappingURL=ngApolloLinkHttpCommon.umd.js.map
