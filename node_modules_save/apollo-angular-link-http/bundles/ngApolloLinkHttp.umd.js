(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common/http'),exports, require('@angular/core'), require('@angular/common/http'), require('apollo-link'), require('graphql'), require('apollo-angular-link-http-common'), require('extract-files')) :
    typeof define === 'function' && define.amd ? define('apollo-angular-link-http', ['@angular/core','@angular/common/http','exports', '@angular/core', '@angular/common/http', 'apollo-link', 'graphql', 'apollo-angular-link-http-common', 'extract-files'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common.http,global.ngApolloLinkHttp = {}, global.ng.core, global.ng.common.http, global.apolloLink.core, global.graphql, global.ngApolloLinkHttpCommon, global.extractFiles));
}(this, (function (ɵngcc0,ɵngcc1,exports, core, http, apolloLink, graphql, apolloAngularLinkHttpCommon, extractFiles) { 'use strict';
...
HttpLink.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: HttpLink, factory: function (t) { return HttpLink.ɵfac(t); } });
